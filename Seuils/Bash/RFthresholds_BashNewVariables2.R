...
Params <- c("NC_NATURAL2_WD", "NC_NATURAL6_WD", "NC_NATURAL7_WD", "NC_CatchStruct2_WD", "NC_AREA1_WD", "NC_ALT3_WD",
...
Params <- split(Params, ceiling(seq_along(Params)/(length(Params)%/%3)))[[Nslice]]
